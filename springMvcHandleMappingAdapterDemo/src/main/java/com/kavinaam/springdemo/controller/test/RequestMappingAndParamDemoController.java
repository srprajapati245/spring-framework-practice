...
public class RequestMappingAndParamDemoController {
    ...
    //test 2: Testing @RequestMapping with 'method' attribute
    ...
    //test 3: Testing @RequestMapping with fallback feature
...
//    @RequestMapping(value = "*", method = {RequestMethod.GET, RequestMethod.POST})
    ...
    //test 4: Testing @RequestParam with 'defaultValue' attribute
    @RequestMapping(value = "/test4")
    public String requestMappingAndParamTest4(@RequestParam(value = "orgname", defaultValue = "Annoymous Organization") String orgName, Model model) {
        model.addAttribute("orgname", orgName);
    ...
    @RequestMapping(value = "/test6")
    public String requestMappingAndParamTest6SubTest2(@RequestParam String orgname, Model model) {
        model.addAttribute("orgname", orgname);
        model.addAttribute("testserial", "test5");
        return "requestMappingAndParamResults2";
    }*/

    //test 6, subTest 1: Testing removal of @RequestMapping ambiguity with the same base URI but with different a different parameter
    ...
    //test 6, subTest 2: Testing removal of @RequestMapping ambiguity with the same base URI but with different a different parameter
    ...
    //test 6, subTest 3: Testing of @RequestMapping with multiple
